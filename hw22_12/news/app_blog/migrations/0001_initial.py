# Generated by Django 4.0 on 2024-01-24 11:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_blog.author', verbose_name='автор')),
            ],
            options={
                'db_table': 'news',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published_at', models.DateTimeField(auto_now_add=True, verbose_name='дата публикации')),
                ('news', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_blog.news', verbose_name='новость')),
            ],
            options={
